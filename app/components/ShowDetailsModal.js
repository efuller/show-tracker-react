      ...
      <div className="modal is-active">
        ...
        <div className="modal-card">
          <header className="modal-card-head">
            ...
            <button className="modal-close" onClick={this.props.onCloseModal}>
              Close
            </button>
          </header>
          ...
          <footer className="modal-card-foot">
            {!this.props.previousShow ? (
              ...
              <a className="icon-previous" onClick={this.props.onPreviousShow}>
                &nbsp;
              </a>
            )}
            {!this.props.nextShow ? (
              ...
              <a className="icon-next" onClick={this.props.onNextShow}>
                &nbsp;
              </a>
            )}
          </footer>
