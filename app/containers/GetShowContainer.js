...
class GetShowContainer extends Component {
  ...
  handleSubmit(event) {
    ...
    getShows(this.state.searchValue).then(showData => {
      this.setState({
  ...
  handlePreviousShow() {
    ...
    const previousShow =
      this.getPreviousShow(this.state.previousShow) || undefined;
  ...
  render() {
    return (
      <div>
        ...
        />
        <ShowList shows={this.state.shows} onOpenModal={this.handleOpenModal} />
        <ShowDetailsModal
